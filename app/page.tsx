...
export default function Page() {
  ...
  const { register, watch, setValue } = useForm<FormValues>({
    defaultValues: {
      ...
      softSkillsCustom: "",
      keySkills: [
        { name: "React", repo: "", link: "" },
        { name: "TypeScript", repo: "", link: "" },
        { name: "Node.js", repo: "", link: "" },
      ],
      links: { github: "", linkedin: "", website: "" },
      badgesPreset: ["TypeScript","React","NextJS","Tailwind","GitHub"],
      style: "emoji",
      statsTheme: "radical",
      sections: { bio: true, softSkills: true, keySkills: true, projects: false, badges: true, stats: true, links: true, fun: false },
      funFact: "",
      quote: "",
    },
    mode: "onChange",
